  ...
  const translateObject = {
    info: {
      ...
      workingHours: [
        {
          day: {
            "pt-BR": "Segunda à sexta-feira",
            "en-US": "Monday to Friday",
          },
          hours: {
            "pt-BR": "10h a 17h",
            "en-US": "10am to 5pm",
    ...
    services: {
      ...
      items: [
        {
          "pt-BR": "Assessoria 1a1",
          "en-US": "1on1 Coaching",
        },
        {
          "en-US": "Company Review",
          "pt-BR": "Avaliação da Empresa",
        },
        {
          "en-US": "Accounts Review",
          "pt-BR": "Avaliação de Contas",
        },
        {
          "en-US": "HR Consulting",
          "pt-BR": "Consultoria HR",
        },
        {
          "en-US": "SEO Optimisation",
          "pt-BR": "Otimização de SEO",
        },
      ],
    },
    company: {
    ...
    ending: {
      legal: [
        {
          "pt-BR": "Termos e condições de uso",
        ...
        {
          "pt-BR": "Política de cookies",
          "en-US": "Cookies",
        },
      ],

      copyright: {
        "en-US": "2024. Softex Pernambuco. All rights reserved.",
        "pt-BR": "2024. Softex Pernambuco. Todos os direitos reservados.",
      },
    },
  };
  return (
    <footer className="bg-white dark:bg-gray-800 lg:grid lg:grid-cols-5">
            ...
            <ul className="mt-8 space-y-1 text-sm text-gray-700 dark:text-gray-200">
              {language === "pt-BR"
                ? translateObject.info.workingHours.map((item, i) => (
                    <li key={`${item.day}-${i}`}>
                      {item.day["pt-BR"]}: {item.hours["pt-BR"]}
                    </li>
                  ))
                : translateObject.info.workingHours.map((item, i) => (
                    <li key={`${item.day}-${i}`}>
                      {item.day["en-US"]}: {item.hours["en-US"]}{" "}
                    </li>
                  ))}
            </ul>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                {translateObject.services.items.map((item, i) => {
                  return (
                    <li key={`${item}-${i}`}>
                      <a
                        href="#"
                        className="text-gray-700 transition dark:text-gray-200 hover:opacity-75"
                      >
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                {translateObject.company.items.map((item, i) => {
                  return (
                    <li key={`${item}-${i}`}>
                      <a
                        href="#"
      ...
      <div className="pb-12 pt-6 flex dark:border-gray-950 items-center justify-evenly lg:col-span-5 border-t w-full border-gray-100">
        ...
        <div className="flex flex-1 items-center justify-center">
          <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-300">
            ...
            {language === "pt-BR"
              ...
              : translateObject.ending.copyright["en-US"]}
          </p>
        </div>
      </div>
    </footer>
